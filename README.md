...
<p align="center">
<img src="https://github.com/mehranmohammadiii/Django-FBV-DRF-TodoApp/blob/main/demo/todo-app.gif" alt="database schema" width="720"/>
</p>
...
```bash
git clone https://github.com/mehranmohammadiii/Django-FBV-DRF-TodoApp
```
